...
public class choose_difficultyController implements Initializable {
    ...
    double x = 0, y = 0;
    getGameScenes getScene = new getGameScenes();
    getGameModeScene getGameModeScene = new getGameModeScene();
    ...
    @FXML
    public void easyDifficulty(ActionEvent event) throws Exception {
        mode = 1;
        Music.setVolume(adjustSound.getValue() / 100);
        TicTacToe2.getPrimStage().setScene(getScene.singlePlayerScene());
    }
    
    @FXML
    void mediumDifficulty(ActionEvent event) throws Exception {
        mode = 2;
        Music.setVolume(adjustSound.getValue() / 100);
        TicTacToe2.getPrimStage().setScene(getScene.singlePlayerScene());
    }
    ...
    @FXML
    void hardDifficulty(ActionEvent event) throws Exception {
        mode = 3;
        Music.setVolume(adjustSound.getValue() / 100);
        TicTacToe2.getPrimStage().setScene(getScene.singlePlayerScene());
    }
    ...
    void back(ActionEvent event) throws Exception {
        Music.setVolume(adjustSound.getValue() / 100);
        TicTacToe2.getPrimStage().setScene(getGameModeScene.gameModeScene());
    }
